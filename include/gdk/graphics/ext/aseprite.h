...
namespace gdk::graphics::ext {
    ...
    /// \brief the most frames, and the most tags, a sheet may have; read_aseprite refuses more
    ///
    /// Public so that what the reader refuses can be asserted rather than believed.
    constexpr std::size_t MOST_ASEPRITE_FRAMES = 65536;
